...
// import ToggleGameBtn from './ToggleGameBtn';

// describe('ToggleGameBtn', () => {
//   const noop = () => {};

//   it('triggers onClick event handler when clicked', () => {
//     const setActive = jest.fn();
//     const toggleGamebtn = shallow(<ToggleGameBtn gameId={null} sessionId={null} active={false} setActive={setActive} />).simulate('click');
//     expect(toggleGamebtn).toBeCalledTimes(1);
//   });

//   it('aria-label attribute is defined', () => {
//     const button = shallow(<ToggleGameBtn onClick={noop} open={false} />);
...
//     const button = shallow(<ToggleGameBtn onClick={noop} open={true} />);
